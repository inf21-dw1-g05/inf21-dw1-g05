...
INSERT INTO Musica(id, nomeMusica, genero,nomeartista,datadelancamento)
Values (1,'Dó','Pop','Matue',2000),
(2,'Malvadão','Trap','Xama',2010),
(3,'Maquina do tempo','Pop','Matue',2020),
(4,'Qualidade','Hip-Hop','Teto',2021),
(5,'Final','Latin','Tilman',2019),
(6,'Craque','Rock','Teto',2014),
(7,'M4','Pop','Teto',2000),
(8,'Bala Azul','Trap','Dinis',1900),
(9,'Tino','Trap','Carl',2007),
(10,'Tomas','Rock','Joao',2021),
(11,'Mustang','Pop','Teto',2020),
(12,'Fashion','Latin','Ruca',2001),
(13,'Salto alto','Pop','Piruka',2010),
(14,'Bang','Pop','Gang',2012),
(15,'Fe','Rock','Matue',2018),
(16,'Class','Pop','To',2013),
(17,'Fin','Pop','Ze',2010),
(18,'Contdown','Rock','Loner',1990),
(19,'Death note','Jazz','Pedro',2000),
(20,'Zumm','Metal','Clark',2010),
(21,'R','Fado','Pedro',2017),
(22,'RQW','Disco','Pappilion',2015),
(23,'Camadas','Hip-hop','Murta',2009),
(24,'Sonhador','Pop','Pk',2020),
(25,'Sweet spot','Pop','Greg',2010),
(26,'Boa sorte','Velha Guarda','Antigo',1990),
(27,'Tom','Pop','Clark',1980),
(28,'GG','Hip-Hop','Tupac',2000),
(29,'Ping','Hip-Hop','Denis',1990),
(30,'Ola','Velha Guarda','Fernand',2000)
;
